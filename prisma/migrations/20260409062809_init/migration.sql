...
CREATE TABLE "user" (
    ...
    "isOnboardingDone" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "user_isOnboardingDone_idx" ON "user"("isOnboardingDone");
...
-- CreateIndex
CREATE UNIQUE INDEX "device_rfid_key" ON "device"("rfid");
